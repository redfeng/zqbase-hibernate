...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v2.html" data-index="0">用户管理</a>
                            </li>
                            <li>
                                <a href="index_v5.html" class="J_menuItem"   >角色管理</a>
                            </li>
                            <li>
                                <a href="index_v6.html" class="J_menuItem"   >权限管理</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="${ctx }/search">
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2016-2017 <a href="http://zqxx.com" target="_blank">zqxx</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script src="${ctx }/static/hplus/js/hplus.min862f.js?v=4.1.0"></script>
