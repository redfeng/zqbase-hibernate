...
<link href="${ctx }/static/hplus/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="${ctx }/static/hplus/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
    <link href="${ctx }/static/hplus/css/animate.min.css" rel="stylesheet">
    <link href="${ctx }/static/hplus/css/style.min862f.css?v=4.1.0" rel="stylesheet">
    <!-- Morris -->
    <link href="${ctx }/static/hplus/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="${ctx }/static/hplus/js/jquery.min63b9.js?v=2.1.4"></script>
    <script src="${ctx }/static/hplus/js/bootstrap.min14ed.js?v=3.3.6"></script>
    <script src="${ctx }/static/hplus/js/plugins/flot/jquery.flot.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${ctx }/static/hplus/js/demo/peity-demo.min.js"></script>
    <script src="${ctx }/static/hplus/js/content.mine209.js?v=1.0.0"></script>
    <script src="${ctx }/static/hplus/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="${ctx }/static/hplus/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="${ctx }/static/hplus/js/demo/sparkline-demo.min.js"></script>
    <script>
